...
const works = [
    ...
    {
        title: "BARPAN",
        category: "Automated Workflows & Consulting",
        image: "/images/content-automation.webp",
        alt: "BARPAN AI automation and digital consulting workstation with connected workflow screens",
        description: "Creative strategy meets intelligent systems. BARPAN designs automated workflows, digital products, and consulting solutions that help organizations create, operate, and grow.",
        url: "https://barpan.4playglobal.com",
        action: "EXPLORE BARPAN",
